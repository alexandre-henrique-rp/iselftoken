...
import { TrendingUp, TrendingDown, Users, Building2, Clock, CheckCircle } from 'lucide-react'
...
export function StartupStatsCards({ stats }: StartupStatsCardsProps) {
  const cards = [
    ...
    },
    {
      ...
      className: 'bg-gradient-to-br from-violet-500/10 to-purple-500/10 border-violet-500/20',
    ...
    },
    {
      ...
      className: 'bg-gradient-to-br from-orange-500/10 to-yellow-500/10 border-orange-500/20',
  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
      {cards.map((card) => {
        ...
        return (
          <Card key={card.title} className={`${card.className} transition-all hover:shadow-lg`}>

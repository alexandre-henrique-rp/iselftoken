export namespace ApiCnpj {
  export interface SuccessResponse {
    ...
    cnaes_secundarios: CnpjSecondaryCnae[];
    natureza_juridica: string;
    regime_tributario: CnpjTaxRegime[];
...
interface CnpjSecondaryCnae {
  codigo: number;
  descricao: string;
}

interface CnpjTaxRegime {
  ano: number;
